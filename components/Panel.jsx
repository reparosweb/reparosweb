...
const publicUrl = slug => `${typeof window !== "undefined" ? window.location.origin : "https://reparosweb.vercel.app"}/${slug}`;
  ...
  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4" style={{backgroundImage:"radial-gradient(700px 350px at 50% 0%, rgba(245,179,1,0.12), transparent)"}}>
      <div className="w-full max-w-md">
        <button onClick={() => { window.location.href = "/"; }} className="text-sm text-slate-300 hover:text-white mb-4">← Voltar</button>
